...
function buildYleCDNImageUrl(base, imsId, extension) {
  ...
  const defaultBase =
    "https://images.cdn.yle.fi/image/upload/f_auto,fl_progressive/q_100/h_" + Math.round(1350*zoomFactor) + ",e_saturation:" + saturation +",c_fill/";
  ...
  return new Promise((resolve, reject) => {
    ...
    imgObj.image.onload = function () {
      ...
      document.getElementById("zoomedslider").min = -Math.abs(
        imgObj.image.naturalHeight - 1350
      );
  ...
  return [
    {
      ...
      rect: { x: 51, y: 797 + arrowOffset, w: 0, h: 0 },
    ...
    },
    {
      ...
      rect: { x: 51, y: 869 + arrowOffset, w: 0, h: 0 },
    ...
    },
    {
      ...
      rect: { x: 51, y: 941 + arrowOffset, w: 0, h: 0 },
    ...
    },
    {
      type: "image",
      url: arrow,
      rect: { x: arrowLocation, y: 725 + arrowOffset, w: 1080, h: 1350 },
      drawOpts: {
        fillStyle: "black",
    ...
    },
    {
      type: "image",
      url: selectedPodd,
      rect: { x: 0, y: +poddHeight + +heightOffset, w: 1080, h: 1350 },
      drawOpts: {
        fillStyle: "black",
        globalCompositeOperation: "destination-in",
      },
...
download_img = function (el) {
  ...
  aDownloadLink.download = "IGtool" + "." + timeStamp + ".png";
